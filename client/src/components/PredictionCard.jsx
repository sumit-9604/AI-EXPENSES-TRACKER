...
export default function PredictionCard({ prediction = 0, total = 0, salary = 0, onUpdateSalary }) {
  ...
  let statusColor = "text-[#597928]";
  let statusBg = "bg-[#A1BC98]/25 border border-[#A1BC98]";
  let progressColor = "bg-gradient-to-r from-[#597928] to-[#778873]";
  ...
  return (
    <div className="h-full flex flex-col justify-between bg-white border border-[#DCCFC0] rounded-3xl p-6 sm:p-7 shadow-[0_10px_30px_-5px_rgba(89,121,40,0.08),0_2px_8px_rgba(0,0,0,0.02)] text-[#597928]">
      <div>
        ...
        <div className="flex items-center justify-between gap-3 mb-5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs font-semibold text-[#597928]/75">Current Outflow & Monthly Forecast</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 mb-5">
          ...
          <div className="p-4 rounded-2xl bg-[#FDF6ED]/60 border border-[#DCCFC0] shadow-sm">
            <div className="flex items-center justify-between text-[#597928]/80 text-xs font-bold mb-1">
              <span>PREDICTED EXPENSES</span>
              <Activity className="w-4 h-4 text-[#597928]" />
            </div>
            <div className="text-2xl sm:text-3xl font-black text-[#597928]">
              ₹{predValue.toLocaleString("en-IN")}
            </div>
            <span className="text-xs font-semibold text-[#597928]/75 mt-1 block">Expected month-end total</span>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-[#FDF6ED]/60 border border-[#DCCFC0] shadow-sm">
            ...
            <span className="text-xs font-semibold text-[#597928]/75 mt-1 block">Actual recorded outflow</span>
          </div>
        </div>
        ...
        {salaryValue > 0 ? (
          <div className="p-4 rounded-2xl bg-[#FDF6ED]/60 border border-[#DCCFC0] shadow-sm mb-4">
            <div className="flex items-center justify-between text-xs sm:text-sm font-black mb-2">
              <span className="text-[#597928]">BUDGET UTILIZATION</span>
            ...
            <div className="flex items-center justify-between text-xs sm:text-sm font-bold pt-2.5 border-t border-[#DCCFC0]">
              <div className="flex items-center gap-1.5 text-[#597928]">
                <Wallet className="w-4 h-4 text-[#597928]" />
                <span>Salary: <strong className="text-[#597928] text-sm">₹{salaryValue.toLocaleString("en-IN")}</strong></span>
              </div>
              <div className="text-right">
                <span className="text-[#597928]/80">Remaining: </span>
                <strong className={`text-sm ${remaining < 0 ? "text-rose-600 font-black" : "text-[#597928] font-black"}`}>
          ...
          <div className="p-5 rounded-2xl bg-[#FDF6ED]/60 border border-[#DCCFC0] text-center mb-4">
            <p className="text-xs sm:text-sm font-bold text-[#597928]">
      ...
      <div className="pt-3 border-t border-[#DCCFC0] flex items-center justify-between text-xs font-bold text-[#597928]">
        <span className="flex items-center gap-1.5">
          <CheckCircle2 className="w-4 h-4 text-[#597928]" />
        ...
        {editingSalary ? (
          <div className="flex items-center gap-1.5">
            <input
              ...
              className="w-28 px-2.5 py-1 bg-white border border-[#DCCFC0] focus:border-[#597928] rounded-lg text-xs font-bold text-[#597928] focus:outline-none"
            />
            <button
              onClick={handleSave}
              className="p-1.5 rounded-lg bg-[#597928] text-white font-bold cursor-pointer hover:bg-[#486320]"
            >
          ...
          <button
            ...
            className="flex items-center gap-1 text-[#597928] hover:text-[#486320] font-extrabold transition-colors cursor-pointer"
          >
